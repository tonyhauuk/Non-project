...
def get_diff_location(image1, image2):
    ...
    # 如果相差超过50则就认为找到了缺口的位置
    for i in range(80, 348):  # 有人可能看不懂这个位置为什么要从62开始看最后一张图（图：3）
...
def main():
    ...
    newScreen2 = './newScreen2.png'
    try:
        os.remove(screenshot)
        os.remove(newScreen)
        os.remove(newScreen2)
    except:
        pass

    driver = webdriver.Firefox()
    driver.get("https://www.toutiao.com/search/?keyword=微软")
    # 等待滑动框出现
...
'''
https://blog.csdn.net/eb_num/article/details/78394958
